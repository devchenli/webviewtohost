...
internal constructor(private var mContext: Context, var webView: WebView) {
    ...
    fun postMessage(jsonString: String) {
        ...
        try {
            ...
            val address =
                jsonObject["street"].toString() + " " + jsonObject["state"].toString() + " " + jsonObject["country"].toString()
    ...
    @JavascriptInterface
    fun adj_complete_registration(data: String) {
        Log.e("adjustEvent", "adjustEvent:$data")
    }

    @JavascriptInterface
    fun adj_purchase1(data: String, num: Double) {
        Log.e("adjustEvent", "adjustEvent:$data,$num")
    }
}
